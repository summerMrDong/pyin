...
public final class WorkshopRequests {
    ...
    public record BlankTemplateRequest(Long directoryId, String name) { }
    public record RenameRequest(String name) { }
    public record NetworkMountRequest(Long directoryId, String name, String url) { }
    public record LocalDirectoryMountRequest(Long directoryId, String root) { }
