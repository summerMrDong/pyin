...
public class CoreSchemaInitializer {
    ...
    public CoreSchemaInitializer(JdbcTemplate jdbcTemplate, PasswordHasher passwordHasher) {
    ...
    private void seedDefaults() {
        String adminPasswordHash = passwordHasher.hash(DEFAULT_ADMIN_PASSWORD);
        insertWhenMissing(
